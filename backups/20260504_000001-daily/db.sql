...
\restrict 7dkO1wdgOaCvj3uA9iBd8QDaM5YXA6yAiIjbm2bVAMJKd9OhWKN4FiT0p1nKatE
...
--
-- Name: CrmProject; Type: TABLE; Schema: public; Owner: catering
--

CREATE TABLE public."CrmProject" (
    id text NOT NULL,
    name text NOT NULL,
    description text,
    "companyId" text,
...
ALTER TABLE public."CrmProject" OWNER TO catering;

--
-- Name: CrmProjectMember; Type: TABLE; Schema: public; Owner: catering
--

CREATE TABLE public."CrmProjectMember" (
    id text NOT NULL,
...
ALTER TABLE public."CrmProjectMember" OWNER TO catering;
...
CREATE TABLE public."CrmTask" (
    ...
    "projectId" text,
    "sortOrder" integer DEFAULT 0 NOT NULL,
    "boardStatus" text DEFAULT 'TODO'::text NOT NULL,
...
--
-- Name: CrmTaskAttachment; Type: TABLE; Schema: public; Owner: catering
--

CREATE TABLE public."CrmTaskAttachment" (
    id text NOT NULL,
    "taskId" text,
    "commentId" text,
    "userId" text NOT NULL,
...
ALTER TABLE public."CrmTaskAttachment" OWNER TO catering;

--
-- Name: CrmTaskChecklist; Type: TABLE; Schema: public; Owner: catering
--

CREATE TABLE public."CrmTaskChecklist" (
    id text NOT NULL,
...
ALTER TABLE public."CrmTaskChecklist" OWNER TO catering;

--
-- Name: CrmTaskChecklistItem; Type: TABLE; Schema: public; Owner: catering
--

CREATE TABLE public."CrmTaskChecklistItem" (
    id text NOT NULL,
...
ALTER TABLE public."CrmTaskChecklistItem" OWNER TO catering;

--
-- Name: CrmTaskComment; Type: TABLE; Schema: public; Owner: catering
--

CREATE TABLE public."CrmTaskComment" (
    id text NOT NULL,
    "taskId" text NOT NULL,
    "userId" text NOT NULL,
    text text NOT NULL,
...
ALTER TABLE public."CrmTaskComment" OWNER TO catering;
...
--
-- Name: DriverRoute; Type: TABLE; Schema: public; Owner: catering
--

CREATE TABLE public."DriverRoute" (
    id text NOT NULL,
...
ALTER TABLE public."DriverRoute" OWNER TO catering;

--
-- Name: DriverRouteCompany; Type: TABLE; Schema: public; Owner: catering
--

CREATE TABLE public."DriverRouteCompany" (
    id text NOT NULL,
    ...
    "unloadedAt" timestamp(3) without time zone,
...
ALTER TABLE public."DriverRouteCompany" OWNER TO catering;
...
--
-- Name: _prisma_migrations; Type: TABLE; Schema: public; Owner: catering
--
...
ALTER TABLE public._prisma_migrations OWNER TO catering;
...
96a01891-c5f4-4dc9-b722-72fafcfa3c73	43140c42-7ee9-4b3c-9d07-79ac69ae6fd8	Чат ООО "ВАНВЕНТ ПК"	COMPANY_SUPPORT	2026-05-02 08:14:29.326	2026-05-02 08:14:29.326
d52852e6-b49a-4b2e-b549-9b49a4aa626a	d3622cc6-34ac-4c9d-9cad-036e1de0471f	Чат Gastroprime	COMPANY_SUPPORT	2026-05-02 11:23:32.773	2026-05-02 11:23:32.773
\.
...
e22965c2-daee-44fb-bd23-9b435c083f90	d52852e6-b49a-4b2e-b549-9b49a4aa626a	c67decbf-fb6b-44db-a24d-4f5949f7f205	t	2026-05-02 11:23:32.777	2026-05-02 11:23:46.488
\.
...
70532d12-8d8b-42dd-b31e-6e2742980e71	Феникс групп	CRM_LEAD	+7 966 035-45-55		\N	\N	\N	\N	\N	\N	\N	\nг. Красногорск  обед на 70-100 человек. Прайс и меню на макс или тг	\N	\N	\N	STANDARD	FULL	GP-20260502-1E4C01	0	0	50000	0	\N	+7 966 035-45-55
69c18e7c-34fc-4759-a626-b856d83af972	ООО ПРимер	ACTIVE	Иванов Иван	Москва ленина	\N	\N	\N	\N	\N	\N	1	Телефон: 7 999 999 99 9	Обед	artyom.shamshurin18@gmail.com	\N	STANDARD	FULL	GP-20260502-F340AB	5000000	0	50000	0	\N	\N
43140c42-7ee9-4b3c-9d07-79ac69ae6fd8	ООО "ВАНВЕНТ ПК"	ACTIVE	Иван	\N	\N	\N	\N	\N	\N	\N	\N	7 916 857-83-20	Обед	\N	\N	STANDARD	FULL	GP-20260502-EFEA95	0	0	50000	60000000	\N	\N
957aef15-3032-476d-b3ec-9d369daa700f	"ООО 700 км"	CRM_LEAD	Тимур		\N	\N	\N	\N	\N	\N	\N	Тимур получил исчерпывающую информацию в макс, заинтересован, ждем обратной связи. Если не будет обратной связи то напомнить о себе 	\N	\N	\N	STANDARD	FULL	GP-20260502-FAE4D8	0	0	50000	0	\N	+7 915 087-46-46
1b0c1102-45b3-41ee-a606-8f1b8862d04f	B&D	CRM_LEAD	Наталья	Протопоповский переулок 9	\N	\N	\N	\N	\N	\N	15	После майских праздников связаться с ними, возможно будет дегустация. Это реабилитационный центр, закрылась столовая. Сейчас их там 15 человек, планируют расширяться. 	\N	\N	\N	STANDARD	FULL	GP-20260502-FF8745	0	0	50000	0	\N	+7 916 640-94-54
9370078b-72c2-44bf-b7eb-4f781235eccd	ООО "Просперо"	CRM_LEAD	Игорь Константинович	Ленинградский проспект, дом 39, стр.14	\N	\N	\N	\N	\N	\N	70	\N	\N	\N	\N	STANDARD	FULL	GP-20260502-92266C	0	0	50000	0	\N	+7 (916) 993-67-18
7b12c69e-afda-49ac-842b-b546b855be4a	ИП Лабурец	ACTIVE	Ирина Юрьевна Олифир	Заречье, Университетская улица, д.5	\N	Заречье, Университетская улица, д.5	ИП Лобрец Ева Андреевна\nИНН: 770373604707\nОГРНИП:  323774600725757\nРасчетный счёт: 40802810002820009401\nБанк: АО «АЛЬФА БАНК» \nБИК: 044525593\nКорр. счёт: 30101810200000000593\nАдрес осуществления деятельности: 143085 РФ, Московская обл., г. Одинцово, р.п. Заречье, ул. Университетская, дом 5\nОКПО: 2027321306\nОКТМО: 45380000000\nОКВЭД: 81.10\n\n\n\t\n___________/Лобурец Е.А./ \n            М.П.	\N	\N	\N	\N	+7 909 933-46-20	Обед	iy.olifir@svo.su	\N	STANDARD	FULL	GP-20260502-1967AD	0	0	50000	0	\N	\N
07c5708e-ae47-40f5-a196-2f38a60a5102	СТК Кладезь	ACTIVE	Катэлина	2 Котляковский переулок , д.18	\N	2 Котляковский переулок , д.18	ИНН: 7734570261\nКПП: 773401001\nОГРН: 1077760812458\nРасчетный счёт: 40702810600000004510\nБанк: «Банк Кремлевский» ООО \nБИК: 044525196\nКорр. счёт: 30101810745250000196\nЮридический адрес: 123098, г. Москва, ул. Маршала Новикова, д.16,подв. пом. 1, ком. 5\nТелефон: +7-985-303-59-71\nЭлектронная почта: helen.2812@yandex.ru\n\nГенеральный директор\n\n______________/Кирилкин Д.С./	\N	\N	\N	\N	\N	Обед	\N	\N	PRIME	FULL	GP-20260502-B14381	0	0	500000	500000	\N	\N
bf3cf79f-010f-43ef-8f96-999bae2e4517	Море шоу	CRM_LEAD	Александра		\N	\N	\N	\N	\N	\N	\N	\nДоставка на 3 дня 15-17 октября в Москва Центр. 120 порций ежедневно. Просит связаться менеджнра, есть тз по меню.  	\N	\N	\N	STANDARD	FULL	GP-20260502-361AED	0	0	50000	0	\N	+79100837632
879ded9e-da6e-445e-b967-3a5ddb687d30	ИП Савинов В.В.	CRM_LEAD	Владислав Владимирович	Минское шоссе, 43-й километр, вл1к3	\N	\N	\N	\N	\N	\N	\N	По этим складам в итоге общаюсь с Юрием, он собирается предложить наше меню арендаторам на следующей неделе. КП и Меню получил, ждем ОС. Напомнить о себе позже, через неделю	\N	\N	\N	STANDARD	FULL	GP-20260502-28A7CC	0	0	50000	0	\N	7 915 296-35-70
0d84c9c0-d5f7-46dc-8a2c-faca4b88400b	"МИЛЛЕНИУМ ГРУПП"	CRM_LEAD	Анна		\N	\N	\N	\N	\N	\N	\N	Требуется поставщик на проведение мероприятий в дилерских центрах. Договор на год. За год 20 мероприятий по разным адресам. Количество человек неизвестно.  Через тендер перезвонить через неделю если не будет уточняющей инфы.\n\n	\N	\N	\N	STANDARD	FULL	GP-20260502-C9927A	0	0	50000	0	\N	+7 925 414-19-08
4a7a67d8-0391-4b28-a67e-05e9bac2f6ca	Тестовый лид	CRM_LEAD	Иван		\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	STANDARD	FULL	GP-20260502-3BD4D4	0	0	50000	0	\N	\N
ecc45c65-cf9c-4f4c-a69a-63dfe05d4cb5	ООО ИНТЕРА ДЕКО	ACTIVE	Ольга	​Улица Лобачевского, 92 к3	\N	​Улица Лобачевского, 92 к3	\N	\N	\N	\N	\N	\N	Обед	\N	\N	PRIME	FULL	GP-20260502-CE8017	0	0	50000	0	\N	\N
9c90febc-840e-4809-859e-40bb45d0bf38	Тест Контракт	ACTIVE	Test		\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	STANDARD	FULL	GP-20260502-4B0D2C	0	0	50000	0	\N	\N
2715e17c-79f9-440a-907c-86ad2329e663	АО КБП	CRM_LEAD	Евгения		\N	\N	\N	\N	\N	\N	\N	\nСделать до \nПн, 4 мая, 12:00\n\nЗвонил Евгение 17 апреля, мило побеседовали, рассказал про приложуху и личный кабинет. Но пока нет от руководства никаких указаний и ответов. Сказала напомнить о себе через пару недель.	\N	\N	\N	STANDARD	FULL	GP-20260502-53DE16	0	0	50000	0	\N	+7 950 912-56-06
c078f78a-2d34-41c7-aa06-32ebec85d288	ИП	CRM_LEAD	Ольга		\N	\N	\N	\N	\N	\N	\N	Коммерческое предложение Ольга получила в макс и на почту, ждем обратной связи. Напомнить о себе 4 мая в пн.	\N	\N	\N	STANDARD	FULL	GP-20260502-B42DF1	0	0	50000	0	\N	+7 968 889-17-96
2bd7c040-34cf-499e-93a8-60d0228ae003	НИКАПРОМЕД Люблинская	ACTIVE	Светлана Казачкова	\N	\N	\N	\N	\N	\N	\N	\N	\N	Обед	\N	\N	STANDARD	FULL	GP-20260502-15667A	0	0	50000	0	\N	\N
231323be-21b7-40b5-8f9b-bb2013e58c1f	Университет Рудн	CRM_LEAD	Наталья		\N	\N	\N	\N	\N	\N	\N	Пока по объемам она ответить не может, даже гипотетически.\nПросит КП с ценами на каждый бутерброд, Сендвич, сырник, блинчик и все что мы можем предложить в этом ключе + сроки хранения.\nОбозначил ей что доставка бесплатна до них только от 10 тысяч рублей.\nПопросила написать в макс, после еще и на почту.	\N	\N	\N	STANDARD	FULL	GP-20260502-52B65A	0	0	50000	0	\N	+7 963 991-81-81
61f12bb7-241a-4b9d-a73d-b8bc5f5495b1	Промед Габричевского	ACTIVE	Майа	Москва, Габричевского, 5 корпус 5	\N	Москва, Габричевского, 5 корпус 5	\N	\N	\N	\N	1	\N	Обед	\N	\N	STANDARD	FULL	GP-20260502-C0901E	494208	1872	50000	0	\N	\N
a3258b35-9579-4d15-938b-1cb5ef8b1635	Распак груп	ACTIVE	Юрмашева Оксана Александровна	Москва, Электролитный проезд 3,корпус 1	\N	Москва, Электролитный проезд 3,корпус 1	ООО  «РаспакГрупп»\nИНН: 9726043219\nКПП: 772601001\nОГРН: 1237700295470\nРасчетный счёт: 40702810025600001024  \nБанк: ФИЛИАЛ "ЦЕНТРАЛЬНЫЙ" БАНКА ВТБ (ПАО)\nБИК: 044525411 \nКорр. счёт: 30101810145250000411\nЮридический адрес:  115230, г. Москва, муниципальный округ Нагорный вн. тер.г., Электролитный проезд, д.3, стр.42.\nОКПО: 96215188\nОсновной ОКВЭД:10.84\n\t\nГенеральный Директор:\n\t\n__________________ /Фетисенкова В.В./  \nм.п.	\N	\N	\N	\N	+7 905 502-57-50	Обед	o.yurmasheva@raspak.ru	\N	STANDARD	FULL	GP-20260502-7C407C	0	0	50000	500000	\N	\N
a88ff1d0-ca30-485f-a544-556673945ac6	АО центр Звездный	CRM_LEAD	Алексей		\N	\N	\N	\N	\N	\N	\N	Связался с клиентом по МАКС и выслал КП и меню по почте. \nUpdate: Алексей всерьез рассматривает наше предложение, но в компании много внутренних процессов, требуется время и он обязательно вернутся к обсуждению. Если нет, в конце апреля напомнить о себе. НАстроен дружественно) Раньше июня вряди что-то решится, договорились связаться ближе к июню как раз. У них такие решения происходят на уровне совета директоров, и это очень небыстро.	\N	\N	\N	STANDARD	FULL	GP-20260502-2DDFA8	0	0	50000	0	\N	+7 927 369-17-17
15c29133-d544-453f-a813-99913562872e	Кафе	CRM_LEAD	Сергей		\N	\N	\N	\N	\N	\N	\N	Получить ос от Сергея по Макс. Отправил все ему по почте 20 апреля. 27 запросил ос, трубки не берет, на сообщения молчит.	\N	\N	\N	STANDARD	FULL	GP-20260502-ADED6A	0	0	50000	0	\N	+7 980 203-34-09
6fd10f08-eaee-4d0d-8fd0-e661ffc0c89e	Темщица Анастасия	CRM_LEAD	Анастасия		\N	\N	\N	\N	\N	\N	\N	Не отвечает на телефон и на телегу, читает. Перезвоню через пару недель, клиент не серьезный.	\N	\N	\N	STANDARD	FULL	GP-20260502-6BA994	0	0	50000	0	\N	+7 917 528-00-23
e4ca33cb-6e7a-467f-a221-4c8b9d6f2fbe	Крост.Недвижимость	CRM_LEAD	Роман 		\N	\N	\N	\N	\N	\N	\N	Клиент получил коммерческое предложение и меню в макс.\ngordienko_ra@krost.ru\n\nСейчас получает Ос от своих сотрудников, напомнит о себе в среду.\n\nФильтр + поиск\n30 апреля	\N	\N	\N	STANDARD	FULL	GP-20260502-13C3A8	0	0	50000	0	\N	+7 926 395-69-72
91f23e46-7e62-4c96-ac60-6d11c4b4ba45	ООО РВЕ	CRM_LEAD	Эллеонора		\N	\N	\N	\N	\N	\N	\N	Офис клиента РВЕ отказался от комплексных обедов в пользу вендинговых аппаратов. НО! У них производство в состоянии переезда в Красногорск, там работают 180 человек. Сказали что им это возможно будет интересно, попросили связаться после переезда с 29 апреля. контакт тот же - Элеонора. \n\nАпдейт 30 апреля: "затянулся процесс переезда, 5-6 числа я поеду посмотрю как он осуществлен. И встречусь с директором, как раз планируем обсуждать вопрос питания. Я к вам вернусь"	\N	\N	\N	STANDARD	FULL	GP-20260502-A29F8A	0	0	50000	0	\N	+7 964 504-55-68
7ecc3db9-81f4-4e6d-850e-0f04b2e61c0f	«Торговый дом «Мосбетон»	CRM_LEAD	Наталья		\N	\N	\N	\N	\N	\N	\N	16 апреля связывался с Натальей, пока нет ОС и четкого ответа. Попросила перезвонить 29 апреля\n\nАпдейт. Связался 30 апреля, вопрос у них отпал, возможно надолго. Если что напомнить о себе через пару месяцев.	\N	\N	\N	STANDARD	FULL	GP-20260502-34768B	0	0	50000	0	\N	+7 963 991-81-81
a35dadcb-0177-4af3-96a3-c4e118d41b96	Связьстройдеталь	CRM_LEAD	Антонина		\N	\N	\N	\N	\N	\N	\N	Выяснилось что мы им подходим, потому что они хотят сменить оператора столовой. Напомнить о себе через месяц, может все-же согласятся.	\N	\N	\N	STANDARD	FULL	GP-20260502-68E08C	0	0	50000	0	\N	+7 980 712-45-98
8adc35cb-37ff-4f95-be4a-b693f22eba61	ООО "ИНТАКТ"	CRM_LEAD	Виктория		\N	\N	\N	\N	\N	\N	\N	Списаться в июне если не будет никакой обратной связи до.\n\nПамятка: клиент утверждает что им делают обеды в именной крабовой упаковке (1 2 и салат) за 350 рублей включительно, что для нас слишком мало. Будут обсуждать с начальством.	\N	hrd@intact.ru	\N	STANDARD	FULL	GP-20260502-0B2C72	0	0	50000	0	\N	+7 967 320-45-00
01d26a80-bd72-4536-9be5-c814bda340cc	МЕДИПАЛ	CRM_LEAD	Евгения Черковская		\N	\N	\N	\N	\N	\N	\N	Компания по производству медицинских препаратов \n\n60-70 человек\nРассматривают обед\n\nОкно доставки с 8:00 до 12:00\n\nЦену обсуждали 380 руб\nОтправили в почту все запрошенные документы для проверки\nЖдем ОС 13 марта  	\N	\N	\N	STANDARD	FULL	GP-20260502-9A60E7	0	0	50000	0	\N	+7 916 446-37-04
2fc04e1f-c47b-4151-9a6c-9972a2471fb9	Ип Виноградов	CRM_LEAD	Антон		\N	\N	\N	\N	\N	\N	\N	Дал обратная связь что предложение неактуально. Напомнить о себе через месяц.	\N	\N	\N	STANDARD	FULL	GP-20260502-90C24A	0	0	50000	0	\N	+7 915 210-16-67
ad8b42e0-2364-4ec5-bf1c-7c6877b8ea07	Магазин готового питания	CRM_LEAD	Алексей		\N	\N	\N	\N	\N	\N	\N	Клиент получил кп, пока у него ничего не ясно. Перезвонить ему через месяц, если не даст ОС. \nВдруг его магазин будет давать неплохой объем, почему бы и не взять его в итоге?	\N	\N	\N	STANDARD	FULL	GP-20260502-B022EE	0	0	50000	0	\N	7 978 005-40-41
4dc1356d-1955-4ef5-bd7a-48fed1123f46	Проект Дионис	CRM_LEAD	Дионис		\N	\N	\N	\N	\N	\N	\N	Отправил ему меню стандарт в телегу, цена - по 350 рублей мы согласились. Будем работать если нам будет удобно в назначенные им даты и адреса.\nНапомнить о себе через месяц.	\N	\N	\N	STANDARD	FULL	GP-20260502-790129	0	0	50000	0	\N	+7 925 825-05-44
24716d0e-cff8-46ca-983e-27defd6c2c5f	Фрилансер	CRM_LEAD	Алина		\N	\N	\N	\N	\N	\N	\N	Получила кп и меню в телегу. Темщица, непостоянщица. Связаться с Алиной в Мае через месяц, обсудить возможные заказы.	\N	\N	\N	STANDARD	FULL	GP-20260502-39154A	0	0	50000	0	\N	+7 916 571-08-29
e4612b33-ebda-4c7d-9882-e639141c0d22	Natura Siberica	CRM_LEAD	Валерия		\N	\N	\N	\N	\N	\N	\N	Перезвонить в мае, у них сейчас аудит и руководство не собирается решать вопросы с обедами.	\N	\N	\N	STANDARD	FULL	GP-20260502-71AFB0	0	0	50000	0	\N	+7 915 073-16-18
fcd63969-f4b6-4899-abf3-9744471c30d6	Строительная компания	CRM_LEAD	Екатерина Афанасьева		\N	\N	\N	\N	\N	\N	\N	Строительная компания. Охват по всей Москве. Много адресов.\nБолее 200 сотрудников\nДегустация прошла успешно. \nЦену зафиксировали 340 руб.\n\nТребуется выпечка\nХлеб не нужен\n\nПоставила нас в резерв. Есть возможность получить несколько пробных точек.	\N	\N	\N	STANDARD	FULL	GP-20260502-B04AA8	0	0	50000	0	\N	+7 909 563-20-53
2e308a50-592f-43c9-a253-05e51abcac41	МЧС РФ	CRM_LEAD	Анастасия		\N	\N	\N	\N	\N	\N	0	рий\n10:25\nгос. учреждение нужен завтрак, обед и ужин для 66 человек. адрес и название компании отказалась называть. м. Раменки. Так же интересует возможность оформить через госзакупки. Просит связаться как можно скорее.  	\N		\N	STANDARD	FULL	GP-20260502-74B856	0	0	50000	0	\N	+7 916 382-71-19
bb5b2017-88d9-4fff-9283-2196b677bf12	Test Unique Number	CRM_LEAD	Test		\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	STANDARD	FULL	GP-20260502-7184AC	0	0	50000	0	\N	\N
cf7fb3cb-28a1-4ee0-9d84-234b9eb35a83	Test Unique Number	CRM_LEAD	Test		\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	STANDARD	FULL	GP-20260502-F5AE46	0	0	50000	0	\N	\N
\.
...
5ad57fa7-0389-4b8d-928c-d22acf2d2141	2e308a50-592f-43c9-a253-05e51abcac41	dccc0fbf-b687-4042-8c8f-56b925ff9da3	MODERATION	10	\N	COLD	рий\n10:25\nгос. учреждение нужен завтрак, обед и ужин для 66 человек. адрес и название компании отказалась называть. м. Раменки. Так же интересует возможность оформить через госзакупки. Просит связаться как можно скорее.  	0	0	0	5	\N	2026-05-02 07:04:16.892	2026-05-02 08:28:55.946
76642349-6f85-495d-a113-824c9c27567a	15c29133-d544-453f-a813-99913562872e	dccc0fbf-b687-4042-8c8f-56b925ff9da3	QUOTE_SENT	10	\N	COLD	Получить ос от Сергея по Макс. Отправил все ему по почте 20 апреля. 27 запросил ос, трубки не берет, на сообщения молчит.	0	0	0	5	\N	2026-05-02 07:09:21.543	2026-05-02 08:29:08.336
5a9cd3d8-e797-4b97-972a-98dc1db1be89	70532d12-8d8b-42dd-b31e-6e2742980e71	dccc0fbf-b687-4042-8c8f-56b925ff9da3	QUOTE_SENT	10	\N	COLD	\nг. Красногорск  обед на 70-100 человек. Прайс и меню на макс или тг	0	0	0	5	\N	2026-05-02 07:05:27.314	2026-05-02 08:29:34.74
d1249613-68f6-4697-999f-acfea1262773	2715e17c-79f9-440a-907c-86ad2329e663	dccc0fbf-b687-4042-8c8f-56b925ff9da3	QUOTE_SENT	10	\N	COLD	\nСделать до \nПн, 4 мая, 12:00\n\nЗвонил Евгение 17 апреля, мило побеседовали, рассказал про приложуху и личный кабинет. Но пока нет от руководства никаких указаний и ответов. Сказала напомнить о себе через пару недель.	0	0	0	5	\N	2026-05-02 07:05:58.197	2026-05-02 08:29:38.392
ef2eb0d0-aa06-4843-8a0a-12679ec1f71d	c078f78a-2d34-41c7-aa06-32ebec85d288	dccc0fbf-b687-4042-8c8f-56b925ff9da3	QUOTE_SENT	10	\N	COLD	Коммерческое предложение Ольга получила в макс и на почту, ждем обратной связи. Напомнить о себе 4 мая в пн.	0	0	0	5	\N	2026-05-02 07:06:35.783	2026-05-02 08:29:42.513
8f43d617-f1bf-4097-b40d-ba85e097ea8e	9370078b-72c2-44bf-b7eb-4f781235eccd	dccc0fbf-b687-4042-8c8f-56b925ff9da3	MODERATION	10	\N	COLD	70 человек, цены от 390 до 600, график 5/2	0	390	600	5	\N	2026-05-02 07:03:42.021	2026-05-02 07:24:07.799
935769b3-1412-4f01-8516-7912a775850f	6fd10f08-eaee-4d0d-8fd0-e661ffc0c89e	dccc0fbf-b687-4042-8c8f-56b925ff9da3	DEFERRED	10	\N	COLD	Не отвечает на телефон и на телегу, читает. Перезвоню через пару недель, клиент не серьезный.	0	0	0	5	\N	2026-05-02 07:09:46.019	2026-05-02 07:48:27.455
90957e85-741f-4205-8311-483071948cd6	e4ca33cb-6e7a-467f-a221-4c8b9d6f2fbe	dccc0fbf-b687-4042-8c8f-56b925ff9da3	DEFERRED	10	\N	COLD	Клиент получил коммерческое предложение и меню в макс.\ngordienko_ra@krost.ru\n\nСейчас получает Ос от своих сотрудников, напомнит о себе в среду.\n\nФильтр + поиск\n30 апреля	0	0	0	5	\N	2026-05-02 07:10:16.343	2026-05-02 07:48:31.404
13ff2b4c-7f0e-440b-9cae-d76c015cc973	957aef15-3032-476d-b3ec-9d369daa700f	dccc0fbf-b687-4042-8c8f-56b925ff9da3	QUOTE_SENT	10	\N	COLD	Тимур получил исчерпывающую информацию в макс, заинтересован, ждем обратной связи. Если не будет обратной связи то напомнить о себе 	0	0	0	5	\N	2026-05-02 07:07:14.457	2026-05-02 07:49:24.977
c003017f-3957-4978-85c8-8e745d25800e	231323be-21b7-40b5-8f9b-bb2013e58c1f	dccc0fbf-b687-4042-8c8f-56b925ff9da3	MODERATION	10	\N	COLD	Пока по объемам она ответить не может, даже гипотетически.\nПросит КП с ценами на каждый бутерброд, Сендвич, сырник, блинчик и все что мы можем предложить в этом ключе + сроки хранения.\nОбозначил ей что доставка бесплатна до них только от 10 тысяч рублей.\nПопросила написать в макс, после еще и на почту.	0	\N	\N	\N	\N	2026-05-02 07:51:30.557	2026-05-02 08:29:05.033
c5bea0ae-2778-46d3-b880-522a44dfff27	7ecc3db9-81f4-4e6d-850e-0f04b2e61c0f	dccc0fbf-b687-4042-8c8f-56b925ff9da3	DEFERRED	10	\N	COLD	16 апреля связывался с Натальей, пока нет ОС и четкого ответа. Попросила перезвонить 29 апреля\n\nАпдейт. Связался 30 апреля, вопрос у них отпал, возможно надолго. Если что напомнить о себе через пару месяцев.	0	0	0	5	\N	2026-05-02 07:11:33.254	2026-05-02 07:48:35.785
e5b7e312-1b51-480b-b8b3-cf47f81b8497	91f23e46-7e62-4c96-ac60-6d11c4b4ba45	dccc0fbf-b687-4042-8c8f-56b925ff9da3	DEFERRED	10	\N	COLD	Офис клиента РВЕ отказался от комплексных обедов в пользу вендинговых аппаратов. НО! У них производство в состоянии переезда в Красногорск, там работают 180 человек. Сказали что им это возможно будет интересно, попросили связаться после переезда с 29 апреля. контакт тот же - Элеонора. \n\nАпдейт 30 апреля: "затянулся процесс переезда, 5-6 числа я поеду посмотрю как он осуществлен. И встречусь с директором, как раз планируем обсуждать вопрос питания. Я к вам вернусь"	0	0	0	5	\N	2026-05-02 07:10:54.794	2026-05-02 07:48:33.512
63918f65-15b3-4f53-98fb-270213e88b63	a35dadcb-0177-4af3-96a3-c4e118d41b96	dccc0fbf-b687-4042-8c8f-56b925ff9da3	DEFERRED	10	\N	COLD	Выяснилось что мы им подходим, потому что они хотят сменить оператора столовой. Напомнить о себе через месяц, может все-же согласятся.	0	0	0	5	\N	2026-05-02 07:12:04.025	2026-05-02 07:48:38.11
b484cb6d-e94b-44d2-b33f-fc15477bbc6c	bb5b2017-88d9-4fff-9283-2196b677bf12	c67decbf-fb6b-44db-a24d-4f5949f7f205	LEAD	10	\N	COLD	\N	0	\N	\N	\N	\N	2026-05-02 11:25:02.731	2026-05-02 11:25:02.731
53270fa0-c9fe-47d3-bdde-8d6de19dc526	cf7fb3cb-28a1-4ee0-9d84-234b9eb35a83	c67decbf-fb6b-44db-a24d-4f5949f7f205	LEAD	10	\N	COLD	\N	0	\N	\N	\N	\N	2026-05-02 11:25:07.504	2026-05-02 11:25:07.504
29947036-babc-4952-b358-8e8858907d58	1b0c1102-45b3-41ee-a606-8f1b8862d04f	dccc0fbf-b687-4042-8c8f-56b925ff9da3	QUOTE_SENT	10	\N	COLD	После майских праздников связаться с ними, возможно будет дегустация. Это реабилитационный центр, закрылась столовая. Сейчас их там 15 человек, планируют расширяться. 	0	0	0	5	\N	2026-05-02 07:08:43.715	2026-05-02 08:29:14.257
a9adea48-9468-4c6f-8ca4-8ddd9b8015a4	a88ff1d0-ca30-485f-a544-556673945ac6	dccc0fbf-b687-4042-8c8f-56b925ff9da3	QUOTE_SENT	10	\N	COLD	Связался с клиентом по МАКС и выслал КП и меню по почте. \nUpdate: Алексей всерьез рассматривает наше предложение, но в компании много внутренних процессов, требуется время и он обязательно вернутся к обсуждению. Если нет, в конце апреля напомнить о себе. НАстроен дружественно) Раньше июня вряди что-то решится, договорились связаться ближе к июню как раз. У них такие решения происходят на уровне совета директоров, и это очень небыстро.	0	0	0	5	\N	2026-05-02 07:07:43.42	2026-05-02 08:29:18.793
270c76fa-e3d2-461c-8cb6-51a5cc667ac7	879ded9e-da6e-445e-b967-3a5ddb687d30	dccc0fbf-b687-4042-8c8f-56b925ff9da3	MODERATION	10	\N	COLD	По этим складам в итоге общаюсь с Юрием, он собирается предложить наше меню арендаторам на следующей неделе. КП и Меню получил, ждем ОС. Напомнить о себе позже, через неделю	0	0	0	7	\N	2026-05-02 07:00:48.841	2026-05-02 08:29:21.747
84b08554-f659-4281-b026-9e2256fd9145	bf3cf79f-010f-43ef-8f96-999bae2e4517	dccc0fbf-b687-4042-8c8f-56b925ff9da3	MODERATION	10	\N	COLD	\nДоставка на 3 дня 15-17 октября в Москва Центр. 120 порций ежедневно. Просит связаться менеджнра, есть тз по меню.  	0	\N	\N	\N	\N	2026-05-02 06:59:34.667	2026-05-02 08:29:24.847
ae5e7a45-2907-42b0-a767-5f919aded8b8	0d84c9c0-d5f7-46dc-8a2c-faca4b88400b	dccc0fbf-b687-4042-8c8f-56b925ff9da3	QUOTE_SENT	10	\N	COLD	Требуется поставщик на проведение мероприятий в дилерских центрах. Договор на год. За год 20 мероприятий по разным адресам. Количество человек неизвестно.  Через тендер перезвонить через неделю если не будет уточняющей инфы.\n\n	0	0	0	5	\N	2026-05-02 07:01:37.373	2026-05-02 08:29:27.8
8260ada8-8c9f-4f9b-9127-79565683230d	8adc35cb-37ff-4f95-be4a-b693f22eba61	dccc0fbf-b687-4042-8c8f-56b925ff9da3	DEFERRED	10	\N	COLD	Списаться в июне если не будет никакой обратной связи до.\n\nПамятка: клиент утверждает что им делают обеды в именной крабовой упаковке (1 2 и салат) за 350 рублей включительно, что для нас слишком мало. Будут обсуждать с начальством.	0	0	0	5	\N	2026-05-02 07:12:29.123	2026-05-02 07:48:40.214
e1899aae-701e-4ff2-bfa1-322763f944f4	2fc04e1f-c47b-4151-9a6c-9972a2471fb9	dccc0fbf-b687-4042-8c8f-56b925ff9da3	DEFERRED	10	\N	COLD	Дал обратная связь что предложение неактуально. Напомнить о себе через месяц.	0	0	0	5	\N	2026-05-02 07:13:30.73	2026-05-02 07:48:42.313
334bbaac-46cb-4823-9c14-9c3f7af4795c	ad8b42e0-2364-4ec5-bf1c-7c6877b8ea07	dccc0fbf-b687-4042-8c8f-56b925ff9da3	DEFERRED	10	\N	COLD	Клиент получил кп, пока у него ничего не ясно. Перезвонить ему через месяц, если не даст ОС. \nВдруг его магазин будет давать неплохой объем, почему бы и не взять его в итоге?	0	0	0	5	\N	2026-05-02 07:14:10.831	2026-05-02 07:48:44.213
187c29a4-7a86-40e5-807f-ea51f5eaf47f	4dc1356d-1955-4ef5-bd7a-48fed1123f46	dccc0fbf-b687-4042-8c8f-56b925ff9da3	DEFERRED	10	\N	COLD	Отправил ему меню стандарт в телегу, цена - по 350 рублей мы согласились. Будем работать если нам будет удобно в назначенные им даты и адреса.\nНапомнить о себе через месяц.	0	0	0	5	\N	2026-05-02 07:14:40.48	2026-05-02 07:48:46.355
fd9e11af-6e33-41b0-b460-ad06349c13ce	24716d0e-cff8-46ca-983e-27defd6c2c5f	dccc0fbf-b687-4042-8c8f-56b925ff9da3	DEFERRED	10	\N	COLD	Получила кп и меню в телегу. Темщица, непостоянщица. Связаться с Алиной в Мае через месяц, обсудить возможные заказы.	0	0	0	5	\N	2026-05-02 07:15:07.196	2026-05-02 07:48:48.072
0a5ba3c0-7bd9-45ac-a0c6-2f7d3e88bbde	e4612b33-ebda-4c7d-9882-e639141c0d22	dccc0fbf-b687-4042-8c8f-56b925ff9da3	DEFERRED	10	\N	COLD	Перезвонить в мае, у них сейчас аудит и руководство не собирается решать вопросы с обедами.	0	0	0	5	\N	2026-05-02 07:15:39.17	2026-05-02 07:48:49.851
b8e1f647-6577-41f4-8641-5d35ca3fc8db	fcd63969-f4b6-4899-abf3-9744471c30d6	dccc0fbf-b687-4042-8c8f-56b925ff9da3	DEFERRED	10	\N	COLD	Строительная компания. Охват по всей Москве. Много адресов.\nБолее 200 сотрудников\nДегустация прошла успешно. \nЦену зафиксировали 340 руб.\n\nТребуется выпечка\nХлеб не нужен\n\nПоставила нас в резерв. Есть возможность получить несколько пробных точек.	0	0	0	5	\N	2026-05-02 07:16:02.81	2026-05-02 07:48:51.717
\.
...
6fd76da8-7ce6-4ee2-9b27-ae021674aa73	c003017f-3957-4978-85c8-8e745d25800e	c67decbf-fb6b-44db-a24d-4f5949f7f205	OTHER	\N	\N	Лид создан через форму создания	2026-05-02 07:51:30.56
45b0aa08-5464-46cc-941b-d6673db6c4dd	b484cb6d-e94b-44d2-b33f-fc15477bbc6c	c67decbf-fb6b-44db-a24d-4f5949f7f205	OTHER	\N	\N	Лид создан через форму создания	2026-05-02 11:25:02.738
ca0930e5-b393-4c07-9d26-05e9163115d2	53270fa0-c9fe-47d3-bdde-8d6de19dc526	c67decbf-fb6b-44db-a24d-4f5949f7f205	OTHER	\N	\N	Лид создан через форму создания	2026-05-02 11:25:07.508
\.
...
--
-- Data for Name: CrmProject; Type: TABLE DATA; Schema: public; Owner: catering
--

COPY public."CrmProject" (id, name, description, "companyId", "dealId", status, color, "createdAt", "updatedAt", "endDate") FROM stdin;
1b691f51-94d7-48f8-8b8a-bbd62f6cf640	Test Project	Test description	\N	\N	ACTIVE	#FF5733	2026-05-02 09:17:22.097	2026-05-02 09:17:22.097	\N
6c954eb9-13f1-452d-a40d-8907e723f812	Test Project	Test description	\N	\N	ACTIVE	#FF5733	2026-05-02 09:17:58.145	2026-05-03 04:42:13.101	\N
\.


--
-- Data for Name: CrmProjectMember; Type: TABLE DATA; Schema: public; Owner: catering
--

COPY public."CrmProjectMember" (id, "projectId", "userId", role, "createdAt") FROM stdin;
3098f3ae-0db1-457f-9cac-3419b7da6bf9	6c954eb9-13f1-452d-a40d-8907e723f812	c67decbf-fb6b-44db-a24d-4f5949f7f205	OWNER	2026-05-02 09:17:58.148
3fa1eae6-4946-4e33-9c16-a1019db18c39	6c954eb9-13f1-452d-a40d-8907e723f812	0bf86eb8-eb1d-4545-afec-54626a300014	MEMBER	2026-05-02 09:34:45.912
f9343ef2-ee58-4f62-8ab3-815a71780cbb	6c954eb9-13f1-452d-a40d-8907e723f812	f169ea1f-3de6-443f-be76-ae367f2f777d	MEMBER	2026-05-02 09:34:48.918
5adb957d-d24a-4dca-b345-93f29e5ab615	6c954eb9-13f1-452d-a40d-8907e723f812	dccc0fbf-b687-4042-8c8f-56b925ff9da3	MEMBER	2026-05-02 09:34:52.001
2913031c-9ac1-4f77-97c3-8616c4cb27c6	6c954eb9-13f1-452d-a40d-8907e723f812	0927c79c-c486-47ab-aba0-888d1393b4ae	MEMBER	2026-05-03 04:42:22.532
4db63d69-deb2-4dfd-a638-ad4c3eafe14e	6c954eb9-13f1-452d-a40d-8907e723f812	b4e0d83a-068d-465c-92aa-995806c59358	MEMBER	2026-05-03 04:42:26.149
\.
...
COPY public."CrmTask" (id, title, description, "userId", "dealId", "companyId", type, priority, status, "dueDate", "completedAt", "createdAt", "updatedAt", "projectId", "sortOrder", "boardStatus", labels, "parentTaskId") FROM stdin;
2954e8a4-de46-4700-8b2c-37795c435979	Subtask: review PR	\N	c67decbf-fb6b-44db-a24d-4f5949f7f205	\N	\N	FOLLOW_UP	NORMAL	COMPLETED	\N	2026-05-02 11:23:08.578	2026-05-02 09:24:00.121	2026-05-02 11:23:08.579	\N	0	TODO	{}	\N
b1fd0b8a-87e3-4724-ac7e-072fb3f20152	Производство	\N	c67decbf-fb6b-44db-a24d-4f5949f7f205	\N	\N	FOLLOW_UP	HIGH	COMPLETED	\N	2026-05-02 11:23:06.563	2026-05-02 09:30:20.333	2026-05-03 04:42:56.594	6c954eb9-13f1-452d-a40d-8907e723f812	0	IN_PROGRESS	{}	\N
901979ba-5d1e-42e0-93e5-58908c742d68	Логистика	First task	c67decbf-fb6b-44db-a24d-4f5949f7f205	\N	\N	FOLLOW_UP	NORMAL	COMPLETED	\N	2026-05-02 11:23:07.707	2026-05-02 09:18:26.045	2026-05-03 04:43:17.442	6c954eb9-13f1-452d-a40d-8907e723f812	0	TODO	{bug,urgent}	\N
\.


--
-- Data for Name: CrmTaskAttachment; Type: TABLE DATA; Schema: public; Owner: catering
--

COPY public."CrmTaskAttachment" (id, "taskId", "commentId", "userId", "fileName", "fileUrl", "mimeType", "sizeBytes", "createdAt") FROM stdin;
\.


--
-- Data for Name: CrmTaskChecklist; Type: TABLE DATA; Schema: public; Owner: catering
--

COPY public."CrmTaskChecklist" (id, "taskId", title, completed, "sortOrder", "createdAt", "updatedAt") FROM stdin;
aef6297d-b997-45b4-9252-a36b142e69e9	901979ba-5d1e-42e0-93e5-58908c742d68	Чек-лист1	f	0	2026-05-02 09:34:04.881	2026-05-02 09:34:04.881
308f90e3-7e39-4ea7-ae41-0743ad28ca2b	b1fd0b8a-87e3-4724-ac7e-072fb3f20152	Приоритет	f	0	2026-05-02 09:36:35.182	2026-05-02 09:36:35.182
\.


--
-- Data for Name: CrmTaskChecklistItem; Type: TABLE DATA; Schema: public; Owner: catering
--

COPY public."CrmTaskChecklistItem" (id, "checklistId", text, completed, "assignedTo", "assignedBy", "sortOrder", "createdAt", "updatedAt") FROM stdin;
9943aa39-23d6-4cf9-9ff6-1f70ea05623b	aef6297d-b997-45b4-9252-a36b142e69e9	Проверить отчет	f	\N	\N	0	2026-05-02 09:34:15.047	2026-05-02 09:34:15.047
\.


--
-- Data for Name: CrmTaskComment; Type: TABLE DATA; Schema: public; Owner: catering
--

COPY public."CrmTaskComment" (id, "taskId", "userId", text, mentions, "createdAt", "updatedAt") FROM stdin;
cc6fb0e1-14cc-4b1a-b7ab-e03661b5abe7	901979ba-5d1e-42e0-93e5-58908c742d68	c67decbf-fb6b-44db-a24d-4f5949f7f205	Test comment with @mentions	{c67decbf-fb6b-44db-a24d-4f5949f7f205}	2026-05-02 09:18:43.916	2026-05-02 09:18:43.916
83c0ef70-91b6-41f8-a791-6d59ca3da09f	901979ba-5d1e-42e0-93e5-58908c742d68	c67decbf-fb6b-44db-a24d-4f5949f7f205	Test comment with @admin	{c67decbf-fb6b-44db-a24d-4f5949f7f205}	2026-05-02 09:19:01.726	2026-05-02 09:19:01.726
7e2b2db4-bfff-47db-9bc4-8c098c149454	901979ba-5d1e-42e0-93e5-58908c742d68	c67decbf-fb6b-44db-a24d-4f5949f7f205	Тестовый коммент	{}	2026-05-02 09:34:04.784	2026-05-02 09:34:04.784
77850ea6-36e5-47fb-b77d-4781fe0ee296	901979ba-5d1e-42e0-93e5-58908c742d68	c67decbf-fb6b-44db-a24d-4f5949f7f205	Новый коммент через API	{}	2026-05-02 09:34:14.992	2026-05-02 09:34:14.992
\.
...
--
-- Data for Name: DriverRoute; Type: TABLE DATA; Schema: public; Owner: catering
--

COPY public."DriverRoute" (id, "driverId", date, "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: DriverRouteCompany; Type: TABLE DATA; Schema: public; Owner: catering
--

COPY public."DriverRouteCompany" (id, "driverRouteId", "companyId", "deliveryStatus", "statusChangedAt", "arrivedAt", "unloadedAt", "departedAt", "driverNote", "sortOrder", "createdAt", "updatedAt") FROM stdin;
\.
...
dccc0fbf-b687-4042-8c8f-56b925ff9da3	alexandr.zh@gastroprime.ru	$2b$10$IWZshRXyU3FqdN7JvmGdAeDwoeGtIiMsTdBjl2y4FugZVxMKOnKvu	Александр	Жидков	Коммерческий директор	\N	\N	\N	ADMIN	ACTIVE	d3622cc6-34ac-4c9d-9cad-036e1de0471f	\N	\N	f	f	f	f	2026-05-02 07:54:11.875	2026-05-02 07:54:11.875
668aaee7-0f64-4eb3-8011-7b3d0b5a67d9	crm_operator@gastroprime.ru	$2b$10$BKvBJ2.3YDSJT46SScCEB.LjXj1qRMdvIgDNug70YvkbUtsS4RE/2	Оператор	\N	\N	\N	\N	\N	CRM_OPERATOR	ACTIVE	\N	\N	\N	f	f	f	f	2026-05-02 07:59:59.27	2026-05-02 07:59:59.27
0bf86eb8-eb1d-4545-afec-54626a300014	nina	$2b$10$BSzsViBd0RggtR1OPEFFoeXW.9JT0yp4c9rFS822zsyMkiUe2V7LK	Нина		\N	\N	\N	\N	CRM_OPERATOR	ACTIVE	d3622cc6-34ac-4c9d-9cad-036e1de0471f	\N	\N	f	f	f	f	2026-05-02 08:15:27.374	2026-05-02 08:15:27.374
b4e0d83a-068d-465c-92aa-995806c59358	Ekaterina	$2b$10$LjK9OPrJ4kTMOGvnaa5EZ.tpVKGpGJUmiKAl3YJiLre5NyVcnU23S	Екатерина	Прищеп	\N	\N	\N	\N	ADMIN	ACTIVE	d3622cc6-34ac-4c9d-9cad-036e1de0471f	\N	\N	f	f	f	f	2026-05-02 08:16:47.373	2026-05-02 08:16:47.373
0927c79c-c486-47ab-aba0-888d1393b4ae	Igor	$2b$10$RQ9GocHpC6VMizCGWPOsyOPz01yYuHOj1YakS.rV/W7q6ezLDuuv.	Игорь	Иванов	производство	\N	\N	\N	ADMIN	ACTIVE	d3622cc6-34ac-4c9d-9cad-036e1de0471f	\N	\N	f	f	f	f	2026-05-02 08:17:24.978	2026-05-02 08:17:24.978
04748ea5-292c-4db1-bf57-259b25090d5f	Anastasiya	$2b$10$z7ehAO/4G55/m/VNTduuBeVd6w0tGBgz2jcRsqao/2i2KIgrhi3n.	Анастасия		фасовка	\N	\N	\N	MANAGER	ACTIVE	d3622cc6-34ac-4c9d-9cad-036e1de0471f	\N	\N	f	f	f	f	2026-05-02 08:17:49.317	2026-05-02 08:17:49.317
f169ea1f-3de6-443f-be76-ae367f2f777d	chupikova	$2b$10$iqBRwdpQ.W9vYlFtvl.Y1uG12aa7Jk7JE1SblAMNe0.qcuU952dau	Анастасия	Чупикова	менеджер	\N	\N	\N	MANAGER	ACTIVE	d3622cc6-34ac-4c9d-9cad-036e1de0471f	\N	\N	f	f	f	f	2026-05-02 08:18:24.499	2026-05-02 08:18:24.499
c67decbf-fb6b-44db-a24d-4f5949f7f205	admin@catering.com	$2b$10$WMTXylsf7SIqZOj96.mvi.jHqdSCivBc6Q7/QZAFtNYxpLilyjSLa	ADMIN	\N	\N	\N	\N	\N	SUPERADMIN	ACTIVE	d3622cc6-34ac-4c9d-9cad-036e1de0471f	\N	\N	f	f	f	f	2026-05-01 12:45:33.643	2026-05-01 12:45:33.643
43d33f16-df98-44d0-8302-f5c5e0dddd5d	driver@gastroprime.ru	$2b$10$y9.T/GMVadCkqGuY0DUzz.9aVpsfcIEPuEFKTZ/kxUgf6KRxHtGpO	Тестовый	Водитель	\N	+79999999999	\N	\N	DRIVER	ACTIVE	\N	\N	\N	f	f	f	f	2026-05-03 22:38:35.506	2026-05-03 22:38:35.506
\.
...
--
-- Data for Name: _prisma_migrations; Type: TABLE DATA; Schema: public; Owner: catering
--

COPY public._prisma_migrations (id, checksum, finished_at, migration_name, logs, rolled_back_at, started_at, applied_steps_count) FROM stdin;
7e6f7218-8513-4003-851f-ab146beee68d	aeec8f88e97cda3275fe256fcc4b5525c16d054fee2d419ea6c855cfbbeee01f	2026-05-02 12:42:35.906433+03	add_endDate_to_crm_project		\N	2026-05-02 12:42:35.906433+03	0
b9f25bb3-e82d-4401-9f28-cb2fef58d01e	dfe3355c68a9acc3897c959baa93ceac07adfc148e418a8bc88c53e4a3de7532	2026-05-02 12:42:40.212074+03	add_crm_task_tracker		\N	2026-05-02 12:42:40.212074+03	0
add-driver-route-manual	manual	2026-05-03 21:58:22.325928+03	add_driver_route_tables		\N	2026-05-03 21:58:22.325928+03	0
\.
...
--
-- Name: CrmProjectMember CrmProjectMember_pkey; Type: CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmProjectMember"
    ADD CONSTRAINT "CrmProjectMember_pkey" PRIMARY KEY (id);


--
-- Name: CrmProject CrmProject_pkey; Type: CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmProject"
    ADD CONSTRAINT "CrmProject_pkey" PRIMARY KEY (id);
...
--
-- Name: CrmTaskAttachment CrmTaskAttachment_pkey; Type: CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmTaskAttachment"
    ADD CONSTRAINT "CrmTaskAttachment_pkey" PRIMARY KEY (id);


--
-- Name: CrmTaskChecklistItem CrmTaskChecklistItem_pkey; Type: CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmTaskChecklistItem"
    ADD CONSTRAINT "CrmTaskChecklistItem_pkey" PRIMARY KEY (id);


--
-- Name: CrmTaskChecklist CrmTaskChecklist_pkey; Type: CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmTaskChecklist"
    ADD CONSTRAINT "CrmTaskChecklist_pkey" PRIMARY KEY (id);


--
-- Name: CrmTaskComment CrmTaskComment_pkey; Type: CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmTaskComment"
    ADD CONSTRAINT "CrmTaskComment_pkey" PRIMARY KEY (id);
...
--
-- Name: DriverRouteCompany DriverRouteCompany_pkey; Type: CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."DriverRouteCompany"
    ADD CONSTRAINT "DriverRouteCompany_pkey" PRIMARY KEY (id);


--
-- Name: DriverRoute DriverRoute_pkey; Type: CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."DriverRoute"
    ADD CONSTRAINT "DriverRoute_pkey" PRIMARY KEY (id);
...
--
-- Name: _prisma_migrations _prisma_migrations_pkey; Type: CONSTRAINT; Schema: public; Owner: catering
--
...
--
-- Name: CrmProjectMember_projectId_userId_key; Type: INDEX; Schema: public; Owner: catering
--

CREATE UNIQUE INDEX "CrmProjectMember_projectId_userId_key" ON public."CrmProjectMember" USING btree ("projectId", "userId");


--
-- Name: CrmProjectMember_userId_idx; Type: INDEX; Schema: public; Owner: catering
--

CREATE INDEX "CrmProjectMember_userId_idx" ON public."CrmProjectMember" USING btree ("userId");


--
-- Name: CrmProject_companyId_idx; Type: INDEX; Schema: public; Owner: catering
--

CREATE INDEX "CrmProject_companyId_idx" ON public."CrmProject" USING btree ("companyId");


--
-- Name: CrmProject_dealId_idx; Type: INDEX; Schema: public; Owner: catering
--

CREATE INDEX "CrmProject_dealId_idx" ON public."CrmProject" USING btree ("dealId");
...
--
-- Name: CrmTaskAttachment_commentId_idx; Type: INDEX; Schema: public; Owner: catering
--

CREATE INDEX "CrmTaskAttachment_commentId_idx" ON public."CrmTaskAttachment" USING btree ("commentId");


--
-- Name: CrmTaskAttachment_taskId_idx; Type: INDEX; Schema: public; Owner: catering
--

CREATE INDEX "CrmTaskAttachment_taskId_idx" ON public."CrmTaskAttachment" USING btree ("taskId");


--
-- Name: CrmTaskChecklistItem_checklistId_idx; Type: INDEX; Schema: public; Owner: catering
--

CREATE INDEX "CrmTaskChecklistItem_checklistId_idx" ON public."CrmTaskChecklistItem" USING btree ("checklistId");


--
-- Name: CrmTaskChecklist_taskId_idx; Type: INDEX; Schema: public; Owner: catering
--

CREATE INDEX "CrmTaskChecklist_taskId_idx" ON public."CrmTaskChecklist" USING btree ("taskId");


--
-- Name: CrmTaskComment_taskId_createdAt_idx; Type: INDEX; Schema: public; Owner: catering
--

CREATE INDEX "CrmTaskComment_taskId_createdAt_idx" ON public."CrmTaskComment" USING btree ("taskId", "createdAt");


--
-- Name: CrmTaskComment_userId_idx; Type: INDEX; Schema: public; Owner: catering
--

CREATE INDEX "CrmTaskComment_userId_idx" ON public."CrmTaskComment" USING btree ("userId");
...
--
-- Name: CrmTask_projectId_idx; Type: INDEX; Schema: public; Owner: catering
--

CREATE INDEX "CrmTask_projectId_idx" ON public."CrmTask" USING btree ("projectId");
...
--
-- Name: DriverRouteCompany_driverRouteId_companyId_key; Type: INDEX; Schema: public; Owner: catering
--

CREATE UNIQUE INDEX "DriverRouteCompany_driverRouteId_companyId_key" ON public."DriverRouteCompany" USING btree ("driverRouteId", "companyId");


--
-- Name: DriverRouteCompany_driverRouteId_sortOrder_idx; Type: INDEX; Schema: public; Owner: catering
--

CREATE INDEX "DriverRouteCompany_driverRouteId_sortOrder_idx" ON public."DriverRouteCompany" USING btree ("driverRouteId", "sortOrder");


--
-- Name: DriverRoute_date_idx; Type: INDEX; Schema: public; Owner: catering
--

CREATE INDEX "DriverRoute_date_idx" ON public."DriverRoute" USING btree (date);


--
-- Name: DriverRoute_driverId_date_idx; Type: INDEX; Schema: public; Owner: catering
--

CREATE INDEX "DriverRoute_driverId_date_idx" ON public."DriverRoute" USING btree ("driverId", date);


--
-- Name: DriverRoute_driverId_date_key; Type: INDEX; Schema: public; Owner: catering
--

CREATE UNIQUE INDEX "DriverRoute_driverId_date_key" ON public."DriverRoute" USING btree ("driverId", date);
...
--
-- Name: CrmProjectMember CrmProjectMember_projectId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmProjectMember"
    ADD CONSTRAINT "CrmProjectMember_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES public."CrmProject"(id) ON DELETE CASCADE;


--
-- Name: CrmProjectMember CrmProjectMember_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmProjectMember"
    ADD CONSTRAINT "CrmProjectMember_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON DELETE CASCADE;


--
-- Name: CrmProject CrmProject_companyId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmProject"
    ADD CONSTRAINT "CrmProject_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES public."Company"(id) ON DELETE CASCADE;


--
-- Name: CrmProject CrmProject_dealId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmProject"
    ADD CONSTRAINT "CrmProject_dealId_fkey" FOREIGN KEY ("dealId") REFERENCES public."CrmDeal"(id) ON DELETE SET NULL;
...
--
-- Name: CrmTaskAttachment CrmTaskAttachment_commentId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmTaskAttachment"
    ADD CONSTRAINT "CrmTaskAttachment_commentId_fkey" FOREIGN KEY ("commentId") REFERENCES public."CrmTaskComment"(id) ON DELETE CASCADE;


--
-- Name: CrmTaskAttachment CrmTaskAttachment_taskId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmTaskAttachment"
    ADD CONSTRAINT "CrmTaskAttachment_taskId_fkey" FOREIGN KEY ("taskId") REFERENCES public."CrmTask"(id) ON DELETE CASCADE;


--
-- Name: CrmTaskAttachment CrmTaskAttachment_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmTaskAttachment"
    ADD CONSTRAINT "CrmTaskAttachment_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id);


--
-- Name: CrmTaskChecklistItem CrmTaskChecklistItem_checklistId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmTaskChecklistItem"
    ADD CONSTRAINT "CrmTaskChecklistItem_checklistId_fkey" FOREIGN KEY ("checklistId") REFERENCES public."CrmTaskChecklist"(id) ON DELETE CASCADE;


--
-- Name: CrmTaskChecklist CrmTaskChecklist_taskId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmTaskChecklist"
    ADD CONSTRAINT "CrmTaskChecklist_taskId_fkey" FOREIGN KEY ("taskId") REFERENCES public."CrmTask"(id) ON DELETE CASCADE;


--
-- Name: CrmTaskComment CrmTaskComment_taskId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmTaskComment"
    ADD CONSTRAINT "CrmTaskComment_taskId_fkey" FOREIGN KEY ("taskId") REFERENCES public."CrmTask"(id) ON DELETE CASCADE;


--
-- Name: CrmTaskComment CrmTaskComment_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmTaskComment"
    ADD CONSTRAINT "CrmTaskComment_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id);
...
--
-- Name: CrmTask CrmTask_parentTaskId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmTask"
    ADD CONSTRAINT "CrmTask_parentTaskId_fkey" FOREIGN KEY ("parentTaskId") REFERENCES public."CrmTask"(id) ON DELETE SET NULL;


--
-- Name: CrmTask CrmTask_projectId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."CrmTask"
    ADD CONSTRAINT "CrmTask_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES public."CrmProject"(id) ON DELETE SET NULL;
...
--
-- Name: DriverRouteCompany DriverRouteCompany_companyId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."DriverRouteCompany"
    ADD CONSTRAINT "DriverRouteCompany_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES public."Company"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: DriverRouteCompany DriverRouteCompany_driverRouteId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."DriverRouteCompany"
    ADD CONSTRAINT "DriverRouteCompany_driverRouteId_fkey" FOREIGN KEY ("driverRouteId") REFERENCES public."DriverRoute"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: DriverRoute DriverRoute_driverId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: catering
--

ALTER TABLE ONLY public."DriverRoute"
    ADD CONSTRAINT "DriverRoute_driverId_fkey" FOREIGN KEY ("driverId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
\unrestrict 7dkO1wdgOaCvj3uA9iBd8QDaM5YXA6yAiIjbm2bVAMJKd9OhWKN4FiT0p1nKatE
